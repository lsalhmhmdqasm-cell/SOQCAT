...
class Shop extends Model
{
    ...
    protected $fillable = ['name', 'description', 'logo', 'status', 'delivery_fee', 'enable_web', 'enable_android', 'enable_ios', 'web_status', 'android_status', 'ios_status', 'web_provisioned_at', 'android_provisioned_at', 'ios_provisioned_at'];
